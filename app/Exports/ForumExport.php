...
class ForumExport implements FromQuery, WithHeadings, WithMapping, WithCustomStartCell, ShouldAutoSize, WithStyles, WithColumnWidths
{
    use Exportable;
    private $drawings = [];
    ...
    public function styles($sheet)
    {
        ...
        $sheet->getStyle('B3:'.$highestCol.$highestRow)->getAlignment()->setHorizontal(horizontalAlignment: 'left');
