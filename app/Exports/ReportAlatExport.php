...
class ReportAlatExport implements FromQuery, WithHeadings, WithMapping, WithCustomStartCell, ShouldAutoSize, WithStyles, WithDrawings, WithColumnWidths
{
    use Exportable;
    private $drawings = [];
    ...
    {
        return ReportAlat::query()->with(['user', 'alat','approved_by','rejected_by']);
    }
