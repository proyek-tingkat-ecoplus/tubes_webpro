    ...
    if (isLogin("Admin")) {
        ...
        let table = new DataTable('#table-role', {
            ...
            columns: [{
                ...
                {
                    data: 'tanggal_jam_buka'
                },
                {
                    data: 'tanggal_jam_tutup'
                },
                {
                    data: null,
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="/pages/kantor_dinas/${data.id}/edit"><i
        ...
        $(".btn-table").append('<a href="/pages/kantor_dinas/add" class="btn btn-primary">Tambah Data</a>');
        $(".pdf-button").append('<button class="btn btn-danger mt-md-0 mt-3 me-2 btn-pdf">Export PDF</button>' +
            ...
            $(".btn-excel").click(function () {
                $.ajax({
                    url: "/api/exports/kantor_dinas/excel",
                    headers: {
                        'Authorization': 'Bearer ' + getTokens()
                    },
                    xhrFields: {
            ...
            $(".btn-pdf").click(function () {
                $.ajax({
                    url: "/api/exports/kantor_dinas/pdf",
                    headers: {
                        'Authorization': 'Bearer ' + getTokens()
                    },
                    xhrFields: {
