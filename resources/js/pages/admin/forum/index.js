...
$(document).ready(function () {
    if (isLogin(["Petugas", "Admin"])) {
        ...
        let table = new DataTable('#table-forum', {
                ...
                // },
                {
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="/pages/forum/${data.id}/edit"><i
        ...
        $(".btn-table").append('<a href="/pages/forum/add" class="btn btn-primary">Tambah Pengguna</a>');
            ...
            $(".btn-excel").click(function () {
                $.ajax({
                    ...
                    success: function (data, status, xhr) {
                        ...
                        link.href = url;
                        link.setAttribute('download', 'forum.xlsx');
            ...
            $(".btn-pdf").click(function () {
                $.ajax({
                    ...
                    success: function (data, status, xhr) {
                        ...
                        const url = window.URL.createObjectURL(data);
                        link.href = url;
                        link.setAttribute('download', 'forum.pdf');
                        document.body.appendChild(link);
                        link.click();
                        link.remove();
