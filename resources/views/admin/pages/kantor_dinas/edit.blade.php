...
@section('content')
<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Master / Kantor Dinas /</span> Edit Kantor</h4>
    <div class="card">
    ...
    @vite(['resources/js/pages/admin/kantor_dinas/editData.js'])
@endsection
