...
<div class="content-wrapper">
    <div class="container ">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Master /</span> Data Comment</h4>
...
<script>
            ...
            },
            {
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="{{ url('pages/comment/${data.id}/edit') }}"><i
    ...
    // })
    $(".btn-table").append('<a href="/pages/comment/add" class="btn btn-primary">Tambah Pengguna</a>');
